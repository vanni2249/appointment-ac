<x-admin.app-layout>
    <x-slot name="header">
        <div class="flex flex-col space-y-4">
            ...
            <div class="flex">
                <x-dropdown align="left" width="48">
                    <x-slot name="trigger">
                        <button class="border px-4 py-2 text-sm rounded flex items-center space-x-2">
        ...
        <x-sidebar-form title="Crear servicio">
            Forma crear servicio
        </x-sidebar-form>
    </x-slot>
